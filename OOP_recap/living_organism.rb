...
class LivingOrganism
    ...
    def alive
        puts "Living organisms move, feed, respire (burn food to make energy), grow, sense their environment, excrete and reproduce. 
        These seven characteristics are sometimes summarized by the words “MRS GREN”. 
        functions of: Movement, Respiration, Sensitivity, Growth, Reproduction,Excretion, Nutrition"
    end
